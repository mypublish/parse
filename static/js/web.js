(function (e) {
    function t(t) {
        for (var n, u, c = t[0], i = t[1], d = t[2], f = 0, s = []; f < c.length; f++) u = c[f], Object.prototype.hasOwnProperty
            .call(o, u) && o[u] && s.push(o[u][0]), o[u] = 0;
    ...
    var l = i;
    a.push([4, "chunk-vendors", "chunk-common"]), r()
})({
    "2d89": function (e, t, r) {
        "use strict";
        var n = r("c23f"),
    ...
    "38a0": function (e, t, r) {
        ...
        var n = r("2b0e"),
            ...
            a = [],
            u = (r("b0c0"), r("4d63"), r("ac1f"), r("25f0"), r("466d"), r("841c"), r("cccf")),
            c = {
                name: "App",
                components: {
                    Player: u["a"]
